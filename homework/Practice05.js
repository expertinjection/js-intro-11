...
let res = num >= 1 && num <= 25 
? '1st quarter ' : num >= 26 && num >= 50 
? '2n quarter' : num >= 51 && num >= 75 
? '3rd quarter' : num > 0 && num <51 
?  '1st half' : '2nd half'
console.log()
...
const num2 = 4;
const num3 = 6;
const res1 = num1 % 2 === 0 && num2 % 2 === 0 && num3 % 2 === 0;
console.log(res1);
...
if(charCode >= 48 && charCode <= 57) {
  ...
  console.log(`"${char}"is a special character`);
    ...
    console.log(`"${char}"is a whitespace`)
//task 4

function hasBlue(word) {
   return word.toLowerCase().includes('blue')
}
console.log(hasBlue('haitham'))
...
console.log(startT('taha'))
console.log(startT('Taha'))
console.log(startT('Ahmed'))
*/
// Bilal ways 
/*
Task01
